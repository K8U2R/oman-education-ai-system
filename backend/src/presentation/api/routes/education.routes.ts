...
// Track Management
router.post("/tracks", authMiddleware.authenticate, EducationController.createTrack);
router.post("/tracks/:trackId/units", authMiddleware.authenticate, EducationController.createUnit);
