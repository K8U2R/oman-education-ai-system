/**
 * Content Management Handlers - معالجات إدارة المحتوى
 *
...
import { z } from "zod";
import { ContentManagementService } from "@/application/services/index.js";
...
export class ContentManagementHandler extends BaseHandler {
  /**
   * إنشاء Content Management Handler
   *
