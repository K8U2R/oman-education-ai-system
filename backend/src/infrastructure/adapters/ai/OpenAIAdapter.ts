...
import { IAIProvider, AICompletionOptions } from '@/domain/interfaces/adapters/ai/IAIProvider.js';
...
export class OpenAIAdapter implements IAIProvider {
  ...
  async chatCompletion(request: any): Promise<any> {
    // request type is likely { messages: ... } or similar
    // Using any for now to avoid import hell, but ideally should import types from domain/ai
