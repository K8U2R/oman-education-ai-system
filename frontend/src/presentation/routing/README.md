...
نظام توجيه متقدم ومتكامل لإدارة المسارات في التطبيق مع دعم كامل للمصادقة، الصلاحيات، التحليلات، والتحميل المسبق.
...
- ✅ **حماية متقدمة للمسارات** - دعم كامل للمصادقة والصلاحيات (RBAC)
...
│   ├── useRouteGuard.ts     # Hook للتحقق من الصلاحيات
...
### useRouteGuard - Hook للتحقق من الصلاحيات
