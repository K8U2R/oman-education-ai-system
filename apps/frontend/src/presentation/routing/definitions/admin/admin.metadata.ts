...
export const adminMetadata: Record<string, RouteMetadata> = {
  [ROUTES.ADMIN_DASHBOARD]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.admin_dashboard',
    icon: Shield,
    layout: 'main',
    showInNav: false,
    analytics: {
  ...
  [ROUTES.ADMIN_USERS]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.manage_users',
    icon: Users,
    layout: 'main',
    showInNav: false,
    analytics: {
  ...
  [ROUTES.ADMIN_WHITELIST]: {
    ...
    breadcrumb: 'breadcrumbs.manage_whitelist',
    icon: ShieldCheck,
    layout: 'main',
    showInNav: false,
    analytics: {
  ...
  [ROUTES.ADMIN_SECURITY_DASHBOARD]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.security_dashboard',
    icon: Shield,
    layout: 'main',
    showInNav: false,
    analytics: {
  ...
  [ROUTES.ADMIN_SECURITY_SESSIONS]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.manage_sessions',
    icon: Users,
    layout: 'main',
    showInNav: false,
  },
  ...
  [ROUTES.ADMIN_SECURITY_ROUTES]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.route_protection',
    icon: Globe,
    layout: 'main',
    showInNav: false,
  },
  [ROUTES.ADMIN_ANALYTICS_ERRORS]: {
    ...
    requiresAuth: true,
    requiredRole: 'admin',
    breadcrumb: 'breadcrumbs.error_dashboard',
    icon: AlertTriangle,
    layout: 'main',
    showInNav: false,
    analytics: {
