...
export class EmailService {
    ...
    async sendVerificationEmail(
        ...
        const content = await this.templateEngine.generateVerificationEmail(displayName, verificationUrl);
    ...
    async sendPasswordResetEmail(
        ...
        // Law 05: Using Injected Template Engine (Delegation)
        const content = await this.templateEngine.generatePasswordResetEmail(displayName, resetUrl);
