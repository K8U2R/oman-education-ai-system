/**
 * Assessment Controller - متحكم التقييمات
 *
...
} from "@/modules/education/dto/assessment.dto.js";
import {
  ...
  getAssessmentStats = async (_req: Request, res: Response): Promise<void> => {
    await this.execute(
      ...
      async () => {
        ...
        this.ok(res, stats, "تم جلب إحصائيات التقييمات");
      },
