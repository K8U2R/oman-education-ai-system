/**
 * Project Controller - متحكم المشاريع
 *
...
import {
  CreateProjectDTO,
  UpdateProjectDTO,
} from "@/modules/education/dto/project.dto.js";

export class ProjectController extends BaseHandler {
  /**
   * إنشاء Project Controller
   *
  ...
  createProject = async (req: Request, res: Response): Promise<void> => {
    await this.execute(
      ...
      async () => {
        ...
        const projectData: any = { ...validatedData, created_by: userId };
