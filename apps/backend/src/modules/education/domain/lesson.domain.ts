...
export const LessonSchema = z.object({
    ...
    sections: z.array(z.object({
        ...
        content: z.string().describe("Detailed educational content for this section"),
        codeSnippet: z.string().optional().describe("Relevant code example if applicable (Markdown format)")
    ...
    })).optional().describe("Optional quiz for self-assessment")
});
