...
import { LessonGeneratorService } from "../../../services/ai/LessonGeneratorService.js";
import { container } from "../../../../../infrastructure/di/Container.js";
import { Request, Response } from "express";
import { GenerateLessonRequest } from "../../../domain/lesson.domain.js";
import {
  PlanTier,
  UserData,
...
export class EducationController extends BaseController {
  ...
  generateLesson = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const lessonGenerator = container.resolve<LessonGeneratorService>(
      ...
      // Adapt request object to service signature (topic, subject, gradeLevel, language)
      // Assuming subject/gradeLevel are part of request or defaulted
      const subject = "General"; // Default or from request
      const gradeLevel = request.level || "General";
